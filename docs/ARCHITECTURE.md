...
| **Self-hosted** | Работа на homelab (например 192.168.88.220) или WSL; свои ключи |
...
6. **Наблюдаемость с первого дня** — структурные логи, метрики gateway (совместимо с Prometheus на 220).
...
|---------|----------|----------|--------|
| L1 | **Operator** | Host, secrets, gateway | Твой сервер 220 |
...
Стыкуется с существующим стеком на 192.168.88.220.
